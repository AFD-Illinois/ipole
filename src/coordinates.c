...
inline void gcov_EdGB_ks(double r, double th, double zeta, double gcov[NDIM][NDIM]){
...
inline void gcov_DCS_ks(double r, double th, double zeta, double gcov[NDIM][NDIM]){
  double cth = cos(th);
  double sth = sin(th);
  double s2 = sth * sth;
  double rho2 = r * r + a * a * cth * cth;
