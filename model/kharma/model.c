...
/*
 * read_info_attribute:
 *   Opens the file, enters the "Info" group, and reads the attribute with the given name.
 *   The value is read into the memory pointed to by "value".
 *
 * Parameters:
 *   filename   - Name of KHARMA dump file.
 *   attr_name  - Name of the attribute to read from the "Info" group.
 ...
 *   value_size - Size of the buffer for TYPE_STR; ignored for numeric types.
 *
 * Returns:
