	      ...
	      double complex N_coord[NDIM][NDIM])
{
    ...
    /*******************************************************************/
	  ...
	  SI2 = (SI1*cosh(aP*x)*exp(-aI*x)
		- (ads0/ap)*sinh(ap*x)*exp(-aI*x)
	  ...
	  SQ2 = (SQ1*exp(-aI*x) 
	       ...
	       + jQ*(1 - exp(-aI*x))/aI
	       + adj*aQ /(aI*(aI2 - aP2)) *(1 - (1 - aI2/aP2)*exp(-aI*x)
	  ...
	  SU2 = (SU1 *exp(-aI* x) 
		...
		+ jU *(1 - exp(-aI* x))/aI
		+ adj *aU /(aI *(aI2 - aP2))* (1 - (1 - aI2/aP2)* exp(-aI *x)
					       - aI/aP2 *(aI* cosh(aP* x) + aP *sinh(aP* x))* exp(-aI* x))
	  ...
	  SV2 = (SV1 *exp(-aI* x) 
	       ...
	       + jV *(1 - exp(-aI* x))/aI
	       + adj* aV /(aI *(aI2 - aP2)) *(1 - (1 - aI2/aP2) *exp(-aI* x)
					      - aI/aP2 *(aI* cosh(aP* x) + aP* sinh(aP *x))* exp(-aI* x))
	       + jI *aV/(aP *(aI2 - aP2))* (-aP + (aP *cosh(aP* x) + aI* sinh(aP* x))* exp(-aI *x)));
